...
class WeatherPage: UIViewController {
    ...
    var CityName = ""
       ...
       private let statusLabel:UILabel = {
           ...
           labl.backgroundColor = .white
           labl.layer.masksToBounds = true
           labl.layer.cornerRadius = 20
           labl.layer.borderColor = UIColor.black.cgColor
           return labl
       }()
       ...
       private let tempLabel:UILabel = {
           let labl = UILabel()
           labl.text = ""
           labl.font = UIFont(name: "ArialRoundedMTBold", size: 90.0)
           labl.textAlignment = .center
           labl.textColor = .black
           labl.backgroundColor = .white
           labl.layer.borderColor = UIColor.black.cgColor
...
extension WeatherPage:UISearchBarDelegate{
